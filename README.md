...
SyncSwap is a seamless and efficient decentralized exchange on the zkSync Era, featuring the future-proofing multi-pool design to allow the integration of various pool
...
## Build
To build artifacts, please make sure you have Yarn installe_
```
$ yarn
$ yarn build
$ yarn test
